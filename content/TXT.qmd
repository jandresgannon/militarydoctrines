---
title: "Text Format"
description: "View and download the documents in .txt file format"
page-layout: full
format:
  html:
...
- [All NSS .txt documents](https://www.dropbox.com/scl/fo/nvz2tl3p1yde8x5t14o1r/ABMuD2p6Ubx75_dbarWtUzA?rlkey=r94e8mwgl5lg5hsgi457ey36i&dl=0)
...
```{r}
# download_dir(
#   path = "data_copy/txt_files/",
#   output_name="all_documents",
#   button_label = "Download all files (.txt)",
...
generate_country_panels <- function() {
  ...
  for (i in 1:nrow(country_summary)) {
    ...
    display_name <- case_when(
      ...
      country_data$country_name == "cookislands" ~ "Cook Islands",
      country_data$country_name == "costarica" ~ "Costa Rica",
      ...
      country_data$country_name == "sierraleone" ~ "Sierra Leone",
          ...
          tags$ul(
            lapply(1:nrow(country_docs), function(j) {
              ...
              language_suffix <- ifelse(tolower(doc$language) != "english" && tolower(doc$language) != "eng",
                                        "_noneng", "")
              file_path <- sprintf("data_copy/txt_files/%s_%s_%s%s.txt", 
